...
Jinxu Xiang did the data pre-processing part which contains change_image function and its inverse function. These functions rotate, zoom, and translate the points and image to standardize them. He also created the average points and worked with Ruiqi Xie on ploting the average images, which help us visualized the difference between each pair of emotions. Everyone worked together on providing ideas of feature extraction and considering possible models. Vikki Sui constructed the basic distance and angle feature function and did the color feature for the nasolabials folds. Wenjie Xie and Jiancong Shen compared the difference between 220 facial ecpression category pairs and added some supplementary distance and angle features into the feature function. Ruiqi did the color feature for the wrinkle between eyebrows. Jinxu improved algorithm speed of feature function and did the model training functions, test functions and the in class predicting file. Jinxu and Vikki constructed the main.Rmd file including the feature extraction, model training, predicting, and diagnosis. 

For the presentation, Jinxu and Vikki worked on the presentation materials together but Jinxu did the powerpoint and the video shooting. 
