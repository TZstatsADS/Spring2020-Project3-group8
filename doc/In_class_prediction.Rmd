...
source("../lib/feature_baseline.R")
load("../output/fiducial_pt_list_inclass.RData")
tm_feature_test_inclass_baseline <- system.time(dat_inclass_baseline <- feature_baseline(fiducial_pt_list_inclass, train_idx))
...
print(paste0("The test time for baseline model is ", time, ' s'))
```
